...
/**
 * Table class for ApprovedReservations
 */
class ApprovedReservations extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->date = new DbField(
            ...
            'date', // Name
            '`date`', // Expression
            CastDateFieldForLike("`date`", 0, "qcresorts_db1"), // Basic search expression
            133, // Type
            10, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->rate_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ApprovedReservationsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ApprovedReservationsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ApprovedReservationsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ApprovedReservationsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ApprovedReservationsView";
            case Config("API_ADD_ACTION"):
                return "ApprovedReservationsAdd";
            case Config("API_EDIT_ACTION"):
                return "ApprovedReservationsEdit";
            case Config("API_DELETE_ACTION"):
                return "ApprovedReservationsDelete";
            case Config("API_LIST_ACTION"):
                return "ApprovedReservationsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ApprovedReservationsView", $parm);
        } else {
            $url = $this->keyUrl("ApprovedReservationsView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ApprovedReservationsAdd?" . $parm;
        } else {
            $url = "ApprovedReservationsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ApprovedReservationsEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ApprovedReservationsList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ApprovedReservationsAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ApprovedReservationsList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ApprovedReservationsDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "ApprovedReservationsList";
