 ...
 * Page class
 */
class TblResortDetailsDelete extends TblResortDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TblResortDetailsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TblResortDetailsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TblResortDetailsList"); // Return to list
                return;
            }
        }
