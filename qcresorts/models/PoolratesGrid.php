 ...
 * Page class
 */
class PoolratesGrid extends Poolrates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoolratesGrid";
    ...
    public $FormName = "fpoolratesgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "PoolratesGrid";
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_ratename") && $CurrentForm->hasValue("o_ratename") && $this->ratename->CurrentValue != $this->ratename->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_rateprice") && $CurrentForm->hasValue("o_rateprice") && $this->rateprice->CurrentValue != $this->rateprice->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_ratearrivaltime") && $CurrentForm->hasValue("o_ratearrivaltime") && $this->ratearrivaltime->CurrentValue != $this->ratearrivaltime->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_ratedeparturetime") && $CurrentForm->hasValue("o_ratedeparturetime") && $this->ratedeparturetime->CurrentValue != $this->ratedeparturetime->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_pool_id") && $CurrentForm->hasValue("o_pool_id") && $this->pool_id->CurrentValue != $this->pool_id->DefaultValue) {
            return false;
        }
        return true;
    }
    ...
    {
        $this->rateid->clearErrorMessage();
        $this->ratename->clearErrorMessage();
        $this->rateprice->clearErrorMessage();
        $this->ratearrivaltime->clearErrorMessage();
        $this->ratedeparturetime->clearErrorMessage();
        $this->pool_id->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->rateid->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
        ...
        if ($CurrentForm->hasValue("o_ratename")) {
            $this->ratename->setOldValue($CurrentForm->getValue("o_ratename"));
        }
        ...
        if ($CurrentForm->hasValue("o_rateprice")) {
            $this->rateprice->setOldValue($CurrentForm->getValue("o_rateprice"));
        }
        ...
        if ($CurrentForm->hasValue("o_ratearrivaltime")) {
            $this->ratearrivaltime->setOldValue($CurrentForm->getValue("o_ratearrivaltime"));
        }
        ...
        if ($CurrentForm->hasValue("o_ratedeparturetime")) {
            $this->ratedeparturetime->setOldValue($CurrentForm->getValue("o_ratedeparturetime"));
        }
        ...
        if ($CurrentForm->hasValue("o_pool_id")) {
            $this->pool_id->setOldValue($CurrentForm->getValue("o_pool_id"));
        }
    }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
        if ($this->rateid->Required) {
            if (!$this->rateid->IsDetailKey && EmptyValue($this->rateid->FormValue)) {
                $this->rateid->addErrorMessage(str_replace("%s", $this->rateid->caption(), $this->rateid->RequiredErrorMessage));
            }
        }
