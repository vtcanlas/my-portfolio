...
class PoolDelete extends Pool
{
    ...
    // CSS class/style
    public $CurrentPageName = "PoolDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PoolList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PoolList"); // Return to list
                return;
            }
        }
