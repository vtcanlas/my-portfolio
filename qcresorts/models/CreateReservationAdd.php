 ...
 * Page class
 */
class CreateReservationAdd extends CreateReservation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CreateReservationAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CreateReservationView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // amountpaid
        $this->amountpaid->setDbValueDef($rsnew, $this->amountpaid->CurrentValue, "", false);
