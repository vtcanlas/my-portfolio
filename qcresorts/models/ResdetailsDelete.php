 ...
 * Page class
 */
class ResdetailsDelete extends Resdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResdetailsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ResdetailsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ResdetailsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ResdetailsList"); // Return to list
                return;
            }
        }
