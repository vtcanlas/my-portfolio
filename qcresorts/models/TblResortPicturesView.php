 ...
 * Page class
 */
class TblResortPicturesView extends TblResortPictures
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TblResortPicturesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("pic_id") ?? Route("pic_id")) !== null) {
                ...
                $returnUrl = "TblResortPicturesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "TblResortPicturesList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "TblResortPicturesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
