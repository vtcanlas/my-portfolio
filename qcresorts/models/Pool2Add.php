...
class Pool2Add extends Pool2
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "Pool2View") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->pool_name->CurrentValue = null;
        $this->pool_name->OldValue = $this->pool_name->CurrentValue;
        $this->pool_description->CurrentValue = null;
        $this->pool_description->OldValue = $this->pool_description->CurrentValue;
        $this->barangay->CurrentValue = null;
        $this->barangay->OldValue = $this->barangay->CurrentValue;
        $this->poolcat->CurrentValue = null;
        $this->poolcat->OldValue = $this->poolcat->CurrentValue;
        $this->address->CurrentValue = null;
        $this->address->OldValue = $this->address->CurrentValue;
        $this->contactno1->CurrentValue = null;
        $this->contactno1->OldValue = $this->contactno1->CurrentValue;
        $this->emailaddress->CurrentValue = null;
        $this->emailaddress->OldValue = $this->emailaddress->CurrentValue;
        $this->socmed->CurrentValue = null;
        $this->socmed->OldValue = $this->socmed->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['pool_name'] = $this->pool_name->CurrentValue;
        $row['pool_description'] = $this->pool_description->CurrentValue;
        $row['barangay'] = $this->barangay->CurrentValue;
        $row['poolcat'] = $this->poolcat->CurrentValue;
        $row['address'] = $this->address->CurrentValue;
        $row['contactno1'] = $this->contactno1->CurrentValue;
        $row['emailaddress'] = $this->emailaddress->CurrentValue;
        $row['socmed'] = $this->socmed->CurrentValue;
