 ...
 * Page class
 */
class TblResortPicturesAdd extends TblResortPictures
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TblResortPicturesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TblResortPicturesView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->pic_id->OldValue = $this->pic_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['pic_id'] = $this->pic_id->CurrentValue;
