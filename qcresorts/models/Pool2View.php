    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("pool_id") ?? Route("pool_id")) !== null) {
                ...
                $returnUrl = "Pool2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "Pool2List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "Pool2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
