 ...
 * Page class
 */
class Resdetails2Delete extends Resdetails2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Resdetails2Delete";
    ...
    // CSS class/style
    public $CurrentPageName = "Resdetails2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("Resdetails2List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("Resdetails2List"); // Return to list
                return;
            }
        }
