 ...
 * Page class
 */
class ResdetailsView extends Resdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResdetailsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ResdetailsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("res_id") ?? Route("res_id")) !== null) {
            ...
            $returnUrl = "ResdetailsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ResdetailsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
