...
class UsersList extends Users
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->idno->AdvancedSearch->toJson(), ","); // Field idno
        ...
        $filterList = Concat($filterList, $this->pword->AdvancedSearch->toJson(), ","); // Field pword
    ...
    protected function restoreFilterList()
    {
        ...
        // Field idno
        $this->idno->AdvancedSearch->SearchValue = @$filter["x_idno"];
        $this->idno->AdvancedSearch->SearchOperator = @$filter["z_idno"];
        $this->idno->AdvancedSearch->SearchCondition = @$filter["v_idno"];
        $this->idno->AdvancedSearch->SearchValue2 = @$filter["y_idno"];
        $this->idno->AdvancedSearch->SearchOperator2 = @$filter["w_idno"];
        $this->idno->AdvancedSearch->save();
        ...
        // Field pword
        $this->pword->AdvancedSearch->SearchValue = @$filter["x_pword"];
        $this->pword->AdvancedSearch->SearchOperator = @$filter["z_pword"];
        $this->pword->AdvancedSearch->SearchCondition = @$filter["v_pword"];
        $this->pword->AdvancedSearch->SearchValue2 = @$filter["y_pword"];
        $this->pword->AdvancedSearch->SearchOperator2 = @$filter["w_pword"];
        $this->pword->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->pword); // pword
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->idno->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("pword", $this->createColumnOption("pword"));
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // pword
            $this->pword->ViewValue = $Language->phrase("PasswordMask");
            ...
            // pword
            $this->pword->HrefValue = "";
            $this->pword->TooltipValue = "";
