 ...
 * Page class
 */
class ApprovedReservationsDelete extends ApprovedReservations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ApprovedReservationsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ApprovedReservationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ApprovedReservationsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ApprovedReservationsList"); // Return to list
                return;
            }
        }
