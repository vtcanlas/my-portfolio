 ...
 * Page class
 */
class ResrateDelete extends Resrate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResrateDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ResrateList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ResrateList"); // Return to list
                return;
            }
        }
