 ...
 * Page class
 */
class ResrateTimeDelete extends ResrateTime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResrateTimeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ResrateTimeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ResrateTimeList"); // Return to list
                return;
            }
        }
