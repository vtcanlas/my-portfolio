 ...
 * Page class
 */
class ResrateTimeEdit extends ResrateTime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResrateTimeEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ResrateTimeList"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ResrateTimeList") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ResrateTimeList"), "", $this->TableVar, true);
        $pageId = "edit";
