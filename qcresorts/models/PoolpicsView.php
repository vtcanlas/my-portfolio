 ...
 * Page class
 */
class PoolpicsView extends Poolpics
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoolpicsView";
    ...
    // CSS class/style
    public $CurrentPageName = "PoolpicsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("pic_id") ?? Route("pic_id")) !== null) {
            ...
            $this->RecKey["pic_id"] = $this->pic_id->QueryStringValue;
        } elseif (Post("pic_id") !== null) {
            $this->pic_id->setFormValue(Post("pic_id"));
            $this->RecKey["pic_id"] = $this->pic_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->pic_id->setQueryStringValue($keyValue);
            $this->RecKey["pic_id"] = $this->pic_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "PoolpicsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PoolpicsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
