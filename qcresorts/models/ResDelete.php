...
class ResDelete extends Res
{
    ...
    // CSS class/style
    public $CurrentPageName = "ResDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ResList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ResList"); // Return to list
                return;
            }
        }
