 ...
 * Page class
 */
class ResrateTimeView extends ResrateTime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResrateTimeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("time_id") ?? Route("time_id")) !== null) {
                ...
                $returnUrl = "ResrateTimeList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "ResrateTimeList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "ResrateTimeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
