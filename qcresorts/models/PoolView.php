...
class PoolView extends Pool
{
    ...
    // CSS class/style
    public $CurrentPageName = "PoolView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("pool_id") ?? Route("pool_id")) !== null) {
            ...
            $returnUrl = "PoolList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PoolList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PoolpicsList?" . Config("TABLE_SHOW_MASTER") . "=pool&" . GetForeignKeyUrl("fk_pool_id", $this->pool_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("PoolpicsGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'pool')) {
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'pool')) {
        ...
        if ($detailPageObj->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'pool')) {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PoolratesList?" . Config("TABLE_SHOW_MASTER") . "=pool&" . GetForeignKeyUrl("fk_pool_id", $this->pool_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
