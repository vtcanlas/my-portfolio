 ...
 * Page class
 */
class Resdetails2Add extends Resdetails2
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'resdetails2';

    // Page object name
    public $PageObjName = "Resdetails2Add";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("Resdetails2List"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "Resdetails2List") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "Resdetails2View") {
