...
/**
 * Table class for resortslisting
 */
class Resortslisting extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`resortslisting`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->active->Lookup = new Lookup('active', 'resortslisting', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->active->Lookup = new Lookup('active', 'resortslisting', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->poolcat->Lookup = new Lookup('poolcat', 'resortslisting', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->poolcat->Lookup = new Lookup('poolcat', 'resortslisting', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`resortslisting`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ResortslistingList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ResortslistingView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ResortslistingEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ResortslistingAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ResortslistingView";
            case Config("API_ADD_ACTION"):
                return "ResortslistingAdd";
            case Config("API_EDIT_ACTION"):
                return "ResortslistingEdit";
            case Config("API_DELETE_ACTION"):
                return "ResortslistingDelete";
            case Config("API_LIST_ACTION"):
                return "ResortslistingList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ResortslistingView", $parm);
        } else {
            $url = $this->keyUrl("ResortslistingView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ResortslistingAdd?" . $parm;
        } else {
            $url = "ResortslistingAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ResortslistingEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ResortslistingList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ResortslistingAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ResortslistingList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ResortslistingDelete");
        }
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->img->UseColorbox) {
            ...
            $this->img->LinkAttrs["data-rel"] = "resortslisting_x_img";
