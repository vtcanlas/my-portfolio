...
/**
 * Table class for Create Reservation
 */
class CreateReservation extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'CreateReservation';
        $this->TableName = 'Create Reservation';
        ...
        $this->amountpaid->Required = true; // Required field
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CreateReservationList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "CreateReservationEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CreateReservationAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "CreateReservationAdd";
            case Config("API_EDIT_ACTION"):
                return "CreateReservationEdit";
            case Config("API_DELETE_ACTION"):
                return "CreateReservationDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CreateReservationView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("CreateReservationView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "CreateReservationAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "CreateReservationAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CreateReservationEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CreateReservationAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("CreateReservationDelete", $this->getUrlParm());
    }
