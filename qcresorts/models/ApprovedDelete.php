 ...
 * Page class
 */
class ApprovedDelete extends Approved
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ApprovedDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ApprovedList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ApprovedList"); // Return to list
                return;
            }
        }
