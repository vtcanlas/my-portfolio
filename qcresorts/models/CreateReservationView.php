 ...
 * Page class
 */
class CreateReservationView extends CreateReservation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CreateReservationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("res_id") ?? Route("res_id")) !== null) {
                ...
                $returnUrl = "CreateReservationList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "CreateReservationList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "CreateReservationList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
