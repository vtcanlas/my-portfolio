 ...
 * Page class
 */
class ApprovedReservationsView extends ApprovedReservations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ApprovedReservationsView";
    ...
    // CSS class/style
    public $CurrentPageName = "ApprovedReservationsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("res_id") ?? Route("res_id")) !== null) {
            ...
            $returnUrl = "ApprovedReservationsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ApprovedReservationsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
