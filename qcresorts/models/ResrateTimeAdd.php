 ...
 * Page class
 */
class ResrateTimeAdd extends ResrateTime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResrateTimeAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ResrateTimeView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->time_id->OldValue = $this->time_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['time_id'] = $this->time_id->CurrentValue;
