...
/**
 * Table class for resdetails2
 */
class Resdetails2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "uname = '".CurrentUserName()."' && approved=0";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("Resdetails2List");
    }
    ...
    {
        global $Language;
        if ($pageName == "Resdetails2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "Resdetails2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "Resdetails2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "Resdetails2View";
            case Config("API_ADD_ACTION"):
                return "Resdetails2Add";
            case Config("API_EDIT_ACTION"):
                return "Resdetails2Edit";
            case Config("API_DELETE_ACTION"):
                return "Resdetails2Delete";
            case Config("API_LIST_ACTION"):
                return "Resdetails2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("Resdetails2View", $parm);
        } else {
            $url = $this->keyUrl("Resdetails2View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Resdetails2Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Resdetails2List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Resdetails2Add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Resdetails2List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("Resdetails2Delete");
        }
    }
