 ...
 * Page class
 */
class PoolcatView extends Poolcat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoolcatView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("cat_id") ?? Route("cat_id")) !== null) {
                ...
                $returnUrl = "PoolcatList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PoolcatList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PoolcatList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
