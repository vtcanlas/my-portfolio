 ...
 * Page class
 */
class PoolratesView extends Poolrates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoolratesView";
    ...
    // CSS class/style
    public $CurrentPageName = "PoolratesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("rateid") ?? Route("rateid")) !== null) {
            ...
            $this->RecKey["rateid"] = $this->rateid->QueryStringValue;
        } elseif (Post("rateid") !== null) {
            $this->rateid->setFormValue(Post("rateid"));
            $this->RecKey["rateid"] = $this->rateid->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->rateid->setQueryStringValue($keyValue);
            $this->RecKey["rateid"] = $this->rateid->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "PoolratesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PoolratesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
