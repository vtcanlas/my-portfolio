 ...
 * Page class
 */
class Resdetails2View extends Resdetails2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Resdetails2View";
    ...
    // CSS class/style
    public $CurrentPageName = "Resdetails2View";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("res_id") ?? Route("res_id")) !== null) {
            ...
            $this->RecKey["res_id"] = $this->res_id->QueryStringValue;
        } elseif (Post("res_id") !== null) {
            $this->res_id->setFormValue(Post("res_id"));
            $this->RecKey["res_id"] = $this->res_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->res_id->setQueryStringValue($keyValue);
            $this->RecKey["res_id"] = $this->res_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "Resdetails2List"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "Resdetails2List"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("Resdetails2List"), "", $this->TableVar, true);
        $pageId = "view";
