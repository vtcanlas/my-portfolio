...
class Res extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->AllDay->DataType = DATATYPE_BOOLEAN;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->AllDay->Lookup = new Lookup('AllDay', 'res', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->AllDay->Lookup = new Lookup('AllDay', 'res', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`res`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ResList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ResEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ResAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ResView", $parm);
        } else {
            $url = $this->keyUrl("ResView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ResList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ResList", "action=copy");
        return $this->addMasterUrl($url);
    }
