 ...
 * Page class
 */
class PoolratesDelete extends Poolrates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoolratesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PoolratesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PoolratesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PoolratesList"); // Return to list
                return;
            }
        }
