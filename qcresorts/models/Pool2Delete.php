 ...
 * Page class
 */
class Pool2Delete extends Pool2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Pool2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("Pool2List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("Pool2List"); // Return to list
                return;
            }
        }
