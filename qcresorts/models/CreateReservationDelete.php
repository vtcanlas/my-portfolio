 ...
 * Page class
 */
class CreateReservationDelete extends CreateReservation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CreateReservationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CreateReservationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CreateReservationList"); // Return to list
                return;
            }
        }
