...
class ResView extends Res
{
    ...
    // CSS class/style
    public $CurrentPageName = "ResView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
            ...
            $returnUrl = "ResList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ResList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
