 ...
 * Page class
 */
class PoolpicsDelete extends Poolpics
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoolpicsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PoolpicsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PoolpicsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PoolpicsList"); // Return to list
                return;
            }
        }
