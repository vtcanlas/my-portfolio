...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'D2w9jug21AxJEU1I', // Random key for encryption
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\project1\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\project1\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-cdc6da58-50cb-4593-9422-d777552b8d32", // Export folder
    ...
    "LOGIN_USERNAME_FIELD_NAME" => "uname",
    "LOGIN_PASSWORD_FIELD_NAME" => "pword",
    "USER_ID_FIELD_NAME" => "",
    ...
    // Email
    "SENDER_EMAIL" => "qcresorts@gmail.com", // Sender email address
    "RECIPIENT_EMAIL" => "vincent.canlas@neu.edu.ph", // Recipient email address
