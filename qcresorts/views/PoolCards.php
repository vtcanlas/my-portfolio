...
?>
    ...
    <?php if ($Page->pool_name->Visible) { // pool_name ?>
        ...
        <div class="row pool_pool_name">
            <div class="col col-sm-4 pool_pool_name"><?= $Page->renderFieldHeader($Page->pool_name) ?></div>
...
<?= $Page->pool_name->getViewValue() ?></span>
    ...
    <?php if ($Page->barangay->Visible) { // barangay ?>
        <?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
        <div class="row pool_barangay">
            <div class="col col-sm-4 pool_barangay"><?= $Page->renderFieldHeader($Page->barangay) ?></div>
...
<?= $Page->barangay->getViewValue() ?></span>
    ...
    <?php if ($Page->uname->Visible) { // uname ?>
        <?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
        <div class="row pool_uname">
            <div class="col col-sm-4 pool_uname"><?= $Page->renderFieldHeader($Page->uname) ?></div>
