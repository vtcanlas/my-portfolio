...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fresdetails2add = new ew.Form("fresdetails2add", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fresdetails2add;

    // Add fields
    var fields = currentTable.fields;
    fresdetails2add.addFields([
    ...
    // Form_CustomValidate
    fresdetails2add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fresdetails2add.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fresdetails2add");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fresdetails2add" id="fresdetails2add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fresdetails2add", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fresdetails2add", "x_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
