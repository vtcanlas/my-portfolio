...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> tbl_resort_details">
...
<div id="gmp_tbl_resort_details" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit()) { ?>
<table id="tbl_tbl_resort_detailslist" class="table table-hover table-sm ew-table"><!-- .ew-table -->
<thead>
