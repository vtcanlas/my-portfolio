...
$Page->showMessage();
?>
<form name="ftbl_resort_detailsadd" id="ftbl_resort_detailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<span id="el_tbl_resort_details_poolcat">
    <select
        ...
        data-select2-id="ftbl_resort_detailsadd_x_poolcat"
...
<script>
loadjs.ready("ftbl_resort_detailsadd", function() {
    var options = { name: "x_poolcat", selectId: "ftbl_resort_detailsadd_x_poolcat" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftbl_resort_detailsadd.lists.poolcat?.lookupOptions.length) {
        options.data = { id: "x_poolcat", form: "ftbl_resort_detailsadd" };
    } else {
        options.ajax = { id: "x_poolcat", form: "ftbl_resort_detailsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="ftbl_resort_detailsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="ftbl_resort_detailsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
