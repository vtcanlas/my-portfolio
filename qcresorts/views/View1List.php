...
<?php if ($Page->pool_name->Visible) { // pool_name ?>
        <th data-name="pool_name" class="<?= $Page->pool_name->headerCellClass() ?>"><div id="elh_view1_pool_name" class="view1_pool_name"><?= $Page->renderFieldHeader($Page->pool_name) ?></div></th>
<?php } ?>
<?php if ($Page->user_id->Visible) { // user_id ?>
        <th data-name="user_id" class="<?= $Page->user_id->headerCellClass() ?>"><div id="elh_view1_user_id" class="view1_user_id"><?= $Page->renderFieldHeader($Page->user_id) ?></div></th>
<?php } ?>
<?php if ($Page->pool_id->Visible) { // pool_id ?>
        <th data-name="pool_id" class="<?= $Page->pool_id->headerCellClass() ?>"><div id="elh_view1_pool_id" class="view1_pool_id"><?= $Page->renderFieldHeader($Page->pool_id) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_view1_pool_name" class="el_view1_pool_name">
...
<span id="el<?= $Page->RowCount ?>_view1_user_id" class="el_view1_user_id">
...
<span id="el<?= $Page->RowCount ?>_view1_pool_id" class="el_view1_pool_id">
