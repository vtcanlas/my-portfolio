...
?>
    ...
    <?php if ($Page->rateid->Visible) { // rateid ?>
        ...
        <div class="row reservationdetails_rateid">
            <div class="col col-sm-4 reservationdetails_rateid"><?= $Page->renderFieldHeader($Page->rateid) ?></div>
...
<?= $Page->rateid->getViewValue() ?></span>
    ...
    <?php if ($Page->pool_name->Visible) { // pool_name ?>
        <?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
        <div class="row reservationdetails_pool_name">
            <div class="col col-sm-4 reservationdetails_pool_name"><?= $Page->renderFieldHeader($Page->pool_name) ?></div>
...
<?= $Page->pool_name->getViewValue() ?></span>
    ...
    <?php if ($Page->ratename->Visible) { // ratename ?>
        <?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
        <div class="row reservationdetails_ratename">
            <div class="col col-sm-4 reservationdetails_ratename"><?= $Page->renderFieldHeader($Page->ratename) ?></div>
...
<?= $Page->ratename->getViewValue() ?></span>
    ...
    <?php if ($Page->rateprice->Visible) { // rateprice ?>
        <?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
        <div class="row reservationdetails_rateprice">
            <div class="col col-sm-4 reservationdetails_rateprice"><?= $Page->renderFieldHeader($Page->rateprice) ?></div>
...
<?= $Page->rateprice->getViewValue() ?></span>
    ...
    <?php if ($Page->ratearrivaltime->Visible) { // ratearrivaltime ?>
        <?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
        <div class="row reservationdetails_ratearrivaltime">
            <div class="col col-sm-4 reservationdetails_ratearrivaltime"><?= $Page->renderFieldHeader($Page->ratearrivaltime) ?></div>
...
<?= $Page->ratearrivaltime->getViewValue() ?></span>
    ...
    <?php if ($Page->ratedeparturetime->Visible) { // ratedeparturetime ?>
        <?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
        <div class="row reservationdetails_ratedeparturetime">
            <div class="col col-sm-4 reservationdetails_ratedeparturetime"><?= $Page->renderFieldHeader($Page->ratedeparturetime) ?></div>
...
<?= $Page->ratedeparturetime->getViewValue() ?></span>
    ...
    <?php if ($Page->user_id->Visible) { // user_id ?>
        <?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
        <div class="row reservationdetails_user_id">
            <div class="col col-sm-4 reservationdetails_user_id"><?= $Page->renderFieldHeader($Page->user_id) ?></div>
            <div class="col col-sm-8"><div<?= $Page->user_id->cellAttributes() ?>>
