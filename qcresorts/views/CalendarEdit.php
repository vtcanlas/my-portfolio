...
?>
<main class="edit">
<form name="fcalendaredit" id="fcalendaredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
...
loadjs.ready(["fcalendaredit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcalendaredit", "x_Start", jQuery.extend(true, {"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcalendaredit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcalendaredit", "x_End", jQuery.extend(true, {"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
