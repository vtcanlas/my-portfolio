...
// Page object
$Resdetails2Edit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { resdetails2: currentTable } });
var currentForm, currentPageID;
var fresdetails2edit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fresdetails2edit = new ew.Form("fresdetails2edit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fresdetails2edit;

    // Add fields
    var fields = currentTable.fields;
    fresdetails2edit.addFields([
    ...
    // Form_CustomValidate
    fresdetails2edit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fresdetails2edit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fresdetails2edit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fresdetails2edit" id="fresdetails2edit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->res_id->Visible) { // res_id ?>
    <div id="r_res_id"<?= $Page->res_id->rowAttributes() ?>>
        <label id="elh_resdetails2_res_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->res_id->caption() ?><?= $Page->res_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->res_id->cellAttributes() ?>>
<span id="el_resdetails2_res_id">
...
<input type="hidden" data-table="resdetails2" data-field="x_res_id" data-hidden="1" name="x_res_id" id="x_res_id" value="<?= HtmlEncode($Page->res_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->pool_id->Visible) { // pool_id ?>
    <div id="r_pool_id"<?= $Page->pool_id->rowAttributes() ?>>
        <label id="elh_resdetails2_pool_id" for="x_pool_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pool_id->caption() ?><?= $Page->pool_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->pool_id->cellAttributes() ?>>
<span id="el_resdetails2_pool_id">
<input type="<?= $Page->pool_id->getInputTextType() ?>" name="x_pool_id" id="x_pool_id" data-table="resdetails2" data-field="x_pool_id" value="<?= $Page->pool_id->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->pool_id->getPlaceHolder()) ?>"<?= $Page->pool_id->editAttributes() ?> aria-describedby="x_pool_id_help">
...
<?php if ($Page->date->Visible) { // date ?>
    <div id="r_date"<?= $Page->date->rowAttributes() ?>>
        <label id="elh_resdetails2_date" for="x_date" class="<?= $Page->LeftColumnClass ?>"><?= $Page->date->caption() ?><?= $Page->date->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->date->cellAttributes() ?>>
<span id="el_resdetails2_date">
<input type="<?= $Page->date->getInputTextType() ?>" name="x_date" id="x_date" data-table="resdetails2" data-field="x_date" value="<?= $Page->date->EditValue ?>" placeholder="<?= HtmlEncode($Page->date->getPlaceHolder()) ?>"<?= $Page->date->editAttributes() ?> aria-describedby="x_date_help">
...
<script>
loadjs.ready(["fresdetails2edit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fresdetails2edit", "x_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->rate_id->Visible) { // rate_id ?>
    <div id="r_rate_id"<?= $Page->rate_id->rowAttributes() ?>>
        <label id="elh_resdetails2_rate_id" for="x_rate_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->rate_id->caption() ?><?= $Page->rate_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->rate_id->cellAttributes() ?>>
<span id="el_resdetails2_rate_id">
<input type="<?= $Page->rate_id->getInputTextType() ?>" name="x_rate_id" id="x_rate_id" data-table="resdetails2" data-field="x_rate_id" value="<?= $Page->rate_id->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->rate_id->getPlaceHolder()) ?>"<?= $Page->rate_id->editAttributes() ?> aria-describedby="x_rate_id_help">
...
<?php if ($Page->fname->Visible) { // fname ?>
    <div id="r_fname"<?= $Page->fname->rowAttributes() ?>>
        <label id="elh_resdetails2_fname" for="x_fname" class="<?= $Page->LeftColumnClass ?>"><?= $Page->fname->caption() ?><?= $Page->fname->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->fname->cellAttributes() ?>>
<span id="el_resdetails2_fname">
<input type="<?= $Page->fname->getInputTextType() ?>" name="x_fname" id="x_fname" data-table="resdetails2" data-field="x_fname" value="<?= $Page->fname->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->fname->getPlaceHolder()) ?>"<?= $Page->fname->editAttributes() ?> aria-describedby="x_fname_help">
...
<?php if ($Page->lname->Visible) { // lname ?>
    <div id="r_lname"<?= $Page->lname->rowAttributes() ?>>
        <label id="elh_resdetails2_lname" for="x_lname" class="<?= $Page->LeftColumnClass ?>"><?= $Page->lname->caption() ?><?= $Page->lname->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->lname->cellAttributes() ?>>
<span id="el_resdetails2_lname">
<input type="<?= $Page->lname->getInputTextType() ?>" name="x_lname" id="x_lname" data-table="resdetails2" data-field="x_lname" value="<?= $Page->lname->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->lname->getPlaceHolder()) ?>"<?= $Page->lname->editAttributes() ?> aria-describedby="x_lname_help">
...
<?php if ($Page->address->Visible) { // address ?>
    <div id="r_address"<?= $Page->address->rowAttributes() ?>>
        <label id="elh_resdetails2_address" for="x_address" class="<?= $Page->LeftColumnClass ?>"><?= $Page->address->caption() ?><?= $Page->address->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->address->cellAttributes() ?>>
<span id="el_resdetails2_address">
<input type="<?= $Page->address->getInputTextType() ?>" name="x_address" id="x_address" data-table="resdetails2" data-field="x_address" value="<?= $Page->address->EditValue ?>" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->address->getPlaceHolder()) ?>"<?= $Page->address->editAttributes() ?> aria-describedby="x_address_help">
...
<?php if ($Page->contactno->Visible) { // contactno ?>
    <div id="r_contactno"<?= $Page->contactno->rowAttributes() ?>>
        <label id="elh_resdetails2_contactno" for="x_contactno" class="<?= $Page->LeftColumnClass ?>"><?= $Page->contactno->caption() ?><?= $Page->contactno->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->contactno->cellAttributes() ?>>
<span id="el_resdetails2_contactno">
<input type="<?= $Page->contactno->getInputTextType() ?>" name="x_contactno" id="x_contactno" data-table="resdetails2" data-field="x_contactno" value="<?= $Page->contactno->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->contactno->getPlaceHolder()) ?>"<?= $Page->contactno->editAttributes() ?> aria-describedby="x_contactno_help">
...
<?php if ($Page->_email->Visible) { // email ?>
    <div id="r__email"<?= $Page->_email->rowAttributes() ?>>
        <label id="elh_resdetails2__email" for="x__email" class="<?= $Page->LeftColumnClass ?>"><?= $Page->_email->caption() ?><?= $Page->_email->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->_email->cellAttributes() ?>>
<span id="el_resdetails2__email">
<input type="<?= $Page->_email->getInputTextType() ?>" name="x__email" id="x__email" data-table="resdetails2" data-field="x__email" value="<?= $Page->_email->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->_email->getPlaceHolder()) ?>"<?= $Page->_email->editAttributes() ?> aria-describedby="x__email_help">
...
<?php if ($Page->proofofpayment->Visible) { // proofofpayment ?>
    <div id="r_proofofpayment"<?= $Page->proofofpayment->rowAttributes() ?>>
        <label id="elh_resdetails2_proofofpayment" class="<?= $Page->LeftColumnClass ?>"><?= $Page->proofofpayment->caption() ?><?= $Page->proofofpayment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->dateuploaded->Visible) { // dateuploaded ?>
    <div id="r_dateuploaded"<?= $Page->dateuploaded->rowAttributes() ?>>
        <label id="elh_resdetails2_dateuploaded" for="x_dateuploaded" class="<?= $Page->LeftColumnClass ?>"><?= $Page->dateuploaded->caption() ?><?= $Page->dateuploaded->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->dateuploaded->cellAttributes() ?>>
<span id="el_resdetails2_dateuploaded">
<input type="<?= $Page->dateuploaded->getInputTextType() ?>" name="x_dateuploaded" id="x_dateuploaded" data-table="resdetails2" data-field="x_dateuploaded" value="<?= $Page->dateuploaded->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->dateuploaded->getPlaceHolder()) ?>"<?= $Page->dateuploaded->editAttributes() ?> aria-describedby="x_dateuploaded_help">
...
<?php if ($Page->uname->Visible) { // uname ?>
    <div id="r_uname"<?= $Page->uname->rowAttributes() ?>>
        <label id="elh_resdetails2_uname" for="x_uname" class="<?= $Page->LeftColumnClass ?>"><?= $Page->uname->caption() ?><?= $Page->uname->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->uname->cellAttributes() ?>>
<span id="el_resdetails2_uname">
<input type="<?= $Page->uname->getInputTextType() ?>" name="x_uname" id="x_uname" data-table="resdetails2" data-field="x_uname" value="<?= $Page->uname->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->uname->getPlaceHolder()) ?>"<?= $Page->uname->editAttributes() ?> aria-describedby="x_uname_help">
...
<?php if ($Page->paymentamount->Visible) { // paymentamount ?>
    <div id="r_paymentamount"<?= $Page->paymentamount->rowAttributes() ?>>
        <label id="elh_resdetails2_paymentamount" for="x_paymentamount" class="<?= $Page->LeftColumnClass ?>"><?= $Page->paymentamount->caption() ?><?= $Page->paymentamount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->paymentamount->cellAttributes() ?>>
<span id="el_resdetails2_paymentamount">
<input type="<?= $Page->paymentamount->getInputTextType() ?>" name="x_paymentamount" id="x_paymentamount" data-table="resdetails2" data-field="x_paymentamount" value="<?= $Page->paymentamount->EditValue ?>" size="30" maxlength="7" placeholder="<?= HtmlEncode($Page->paymentamount->getPlaceHolder()) ?>"<?= $Page->paymentamount->editAttributes() ?> aria-describedby="x_paymentamount_help">
...
<?php if ($Page->approved->Visible) { // approved ?>
    <div id="r_approved"<?= $Page->approved->rowAttributes() ?>>
        <label id="elh_resdetails2_approved" for="x_approved" class="<?= $Page->LeftColumnClass ?>"><?= $Page->approved->caption() ?><?= $Page->approved->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->approved->cellAttributes() ?>>
<span id="el_resdetails2_approved">
<input type="<?= $Page->approved->getInputTextType() ?>" name="x_approved" id="x_approved" data-table="resdetails2" data-field="x_approved" value="<?= $Page->approved->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->approved->getPlaceHolder()) ?>"<?= $Page->approved->editAttributes() ?> aria-describedby="x_approved_help">
...
loadjs.ready("head", function() {
    ew.addEventHandlers("resdetails2");
});
</script>
<script>
